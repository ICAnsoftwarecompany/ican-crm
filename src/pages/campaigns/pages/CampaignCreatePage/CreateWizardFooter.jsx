...
export function CreateWizardFooter({ t, isLastStep, onCancel, onSaveDraft, onContinue, savingDraft, submitting }) {
  return (
    <div className="mt-4 flex items-center justify-between gap-2 border-t border-[var(--border)] pt-4">
      ...
      <div className="flex items-center gap-2">
        <Button variant="outline" onClick={onSaveDraft} loading={savingDraft}>{t('campaigns.create.saveDraft')}</Button>
