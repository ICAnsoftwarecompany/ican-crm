...
import { CalendarDays, Clock3, Link as LinkIcon, Loader2, MapPin, Plus, UserRound, Video } from 'lucide-react'
...
function MeetingCard({ meeting, onOpenDetails }) {
  ...
  return (
    <div
      ...
      className="rounded-xl border border-[#E5F7F8] bg-white p-3 text-start shadow-sm transition hover:border-[#00C2CB] hover:shadow-md"
    >
