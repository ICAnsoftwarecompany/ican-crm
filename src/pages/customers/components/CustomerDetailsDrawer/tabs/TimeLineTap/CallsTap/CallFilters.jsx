...
export function getCallStatusLabel(status) {
  return CALL_STATUS_LABELS[String(status || '').toLowerCase()] || status || 'غير محدد'
}
  ...
  return (
    <div className="flex min-w-0 flex-wrap items-center gap-2">
      <button
        ...
        title="فلترة المكالمات بتاريخ البداية"
      >
