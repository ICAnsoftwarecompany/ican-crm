...
function getReminderWindowMs(reminderBefore, reminderUnit, defaultMs = 30 * 60 * 1000) {
...
function CallCard({ call, onOpenDetails }) {
  ...
  return (
    <button
      ...
      className={`block w-full rounded-xl border p-3 text-start shadow-sm transition hover:border-[#00C2CB] hover:shadow-md ${statusStyle.card}`}
    >
