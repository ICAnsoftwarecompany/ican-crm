    ...
    <div className="mb-3 flex flex-col gap-3 rounded-2xl border border-[#D7EEF0] bg-[#F8FEFF] p-3 shadow-sm xl:flex-row xl:items-center xl:justify-between">
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          <h2 className="truncate text-base font-black text-[#0F172A]">{boardName}</h2>
          <span className="rounded-full bg-white px-2 py-0.5 text-[10px] font-black text-[#64748B]">{taskCount} Tasks</span>
        </div>
      </div>
