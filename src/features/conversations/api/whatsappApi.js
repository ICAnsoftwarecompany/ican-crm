...
export const whatsappApi = {
  getConversations: async (tenant, params) => {
  ...
  sendConversationMessage: async (tenant, conversationId, params) => {
    const res = await httpClient.get(`/api/whatsapp/conversations/${tenant}/${conversationId}/send`, { params })
    return res.data
  },
